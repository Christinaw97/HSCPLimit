...
if __name__ == '__main__':
	...
	input_dir=os.getenv('CMSSW_BASE')+'/src/HiggsAnalysis/HSCPLimit/combine/datacards/test_Ias_probQ/v3/'
	tree_dir=os.getenv('CMSSW_BASE')+'/src/HiggsAnalysis/HSCPLimit/combine/limitTrees/test_Ias_probQ/v3/'
	...
	for ias in list(np.arange(0.3,0.7,0.05)):
			...
			#if not (ias == 0.4 and probq == 0.1):continue
			for sample in samples:
				...
				run_combine = "combine -M AsymptoticLimits --run blind -n.{} {}/{}.txt".format(name, input_dir, name)
